...
public class LongQueryParamInjector implements ValueInjector {

	private boolean encode;
	private String paramName;
	private Long defaultValue = null;

	public LongQueryParamInjector(Class<?> type, Type genericType, AccessibleObject target, LongQueryParam queryParam, String defaultValue, boolean encode, Annotation[] annotations, ResteasyProviderFactory factory) {
		this.encode = encode;
	...
	public Object inject(HttpRequest request, HttpResponse response) {
		String value = request.getUri().getQueryParameters(!encode).getFirst(paramName);
		if (value == null) {
			return defaultValue;
		}
